...
const Extrasection = () => {
    return (
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }} className="hero h-[400px] mix-blend-luminosity" style={{ backgroundImage: 'url(https://media.istockphoto.com/id/121035484/photo/sports-balls-on-grass-from-above.jpg?s=1024x1024&w=is&k=20&c=LH8IbGN4nx9NPV-AVNYsz-xmYQh4oorM3K9gw3eipwc=)', backgroundPosition: 'center' }}>
