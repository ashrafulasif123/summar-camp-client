        ...
        <div className="carousel w-full">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className='absolute top-20 left-20'>
                    ...
                    <p className='w-1/2 text-red-600 text-2xl font-semibold mt-5'>Basketball is a popular team sport played around the world, known for its fast-paced action and high-scoring nature. It is played between two teams, with each team consisting of five players. The objective is to score points by shooting the ball through the opponent's hoop and prevent the opposing team from scoring</p>
                </div>
            </div>
